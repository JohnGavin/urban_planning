...
Quiz questions in [`data/questions.json`](../site/data/questions.json) are generated by Claude based on the source documents above. They are tagged with their source document and section for traceability.
